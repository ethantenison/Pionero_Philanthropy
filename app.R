...
ui <- shinyUI(bootstrapPage
      (theme="bootstrap.css",
            ...
            absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                          ...
                          fluidRow(
                                  column(8,div(h3("Nonprofit Explorer v1.4"))),
                          
                                  column(4,h6("(", textOutput("num_matching", inline=TRUE),"NPOs selected)",style="padding:20px 0 0 0;"))),
                          ...
                          #######################################Search bar
                          fluidRow(
                                  column(12, selectizeInput("search", label = "Search Name: ", choices = plot$npo, selected = NULL, multiple = FALSE,
