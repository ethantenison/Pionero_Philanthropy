...
ui <- shinyUI(
    bootstrapPage(
        ...
        absolutePanel(
            ...
            fluidRow(column(3, offset = 1, style='padding:0px;padding-bottom:0px;',
                            h3("Nonprofit Explorer v2.1")),
                     
                     column(3, style='padding:0px;padding-bottom:0px;',
                     ...
                     column(3, style= 'padding:0px;padding-bottom:0px;',actionButton(
