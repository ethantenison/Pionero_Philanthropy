...
ui <- shinyUI(
        bootstrapPage(
            ...
            tags$head(tags$style(HTML('.form-group, .selectize-control {margin-bottom: 0px;}.box-body 
                     {padding-bottom: 0px;}'))),#changes marginscheckboxes
            tags$style(".pretty.p-default input:checked~.state label:
                     after {background-color: #A7E0AC !important;}"), #change color widgets 
            ...
            absolutePanel(
                ...
                fluidRow(column(6, offset = 1, style='padding:0px;padding-bottom:0px;',
                         ...
                         column(8, offset = 1, style='padding:0px; top:0px;margin-top:-1.5em',
                                h3("(",textOutput("num_matching", inline = TRUE),"selected)")),
                         
                         #Search for Nonprofits by Name 
                         column( 10,offset = 1, style='padding:2px;',selectizeInput(
                             "search",
                             label = "Search Name: ",
                             choices = plot$npo,
                             selected = NULL,
                         ...
                         #Tutorial Button 
                         column(8, offset =1 , style= 'padding:2px;',actionButton(
...
#######################################Adding all the features to the map 
...
#######################################Code for showing the number of nonprofits selected 
